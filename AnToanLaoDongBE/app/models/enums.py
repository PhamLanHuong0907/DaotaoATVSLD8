...
class ApprovalStatus(str, Enum):
    DRAFT = "draft"
    PENDING_DEPT_REVIEW = "pending_dept_review"   # Cấp 1: Duyệt phòng ban
    DEPT_APPROVED = "dept_approved"               # Cấp 1 đã duyệt
    PENDING_REVIEW = "pending_review"             # Cấp 2: Duyệt cụ thể
    APPROVED = "approved"
    REJECTED = "rejected"
