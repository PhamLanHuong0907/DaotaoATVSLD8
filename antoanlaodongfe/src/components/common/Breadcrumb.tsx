...
const routeMap: { prefix: string; label: string }[] = [
    ...
    { prefix: '/admin/users', label: 'Hệ thống' },
    { prefix: '/admin/departments', label: 'Hệ thống' },
    { prefix: '/admin/catalogs', label: 'Hệ thống' },
    { prefix: '/admin/settings', label: 'Hệ thống' },
    { prefix: '/admin/audit-logs', label: 'Hệ thống' },
    { prefix: '/admin/webhooks', label: 'Hệ thống' },
    { prefix: '/admin/approvals', label: 'Hệ thống' },
...
export default function Breadcrumb() {
    ...
    const { data: room } = useQuery({
        queryKey: ['exam-room', entityId], // Query key giống với useExamRoom
    ...
    }), [course, document, question, room, template]);
