...
function OccupationCourseSection({
  ...
  // Tự động mở Accordion nếu người dùng đang dùng bộ lọc client-side
  useEffect(() => {
    if (hasClientFilters) {
      setExpanded(true);
    }
  ...
  // Nếu đang xem chi tiết HOẶC có sử dụng filter nội bộ, phải tải Full Data thay vì chỉ lấy count
