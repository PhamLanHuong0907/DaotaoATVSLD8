...
import { examModeLabels, getUnifiedStatus } from '@/utils/vietnameseLabels';
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          <Card variant="outlined">
            <CardContent>
              ...
              <Box sx={{ mt: 0.5 }}>
                {(() => {
                  const uni = getUnifiedStatus(room.approval_status, room.scheduled_start, room.scheduled_end);
                  return <Chip label={uni.label} color={uni.color} />;
                })()}
              </Box>
            </CardContent>
          </Card>
